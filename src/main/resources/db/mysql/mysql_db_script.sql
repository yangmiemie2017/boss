...
INSERT INTO `boss`.`user` (`ID`, `USER_NAME`, `USER_PWD`, `NAME`) VALUES ('1', 'admin', 'admin', 'admin');
INSERT INTO `boss`.`user` (`ID`, `USER_NAME`, `USER_PWD`, `NAME`) VALUES ('2', 'test', 'test', 'test');
INSERT INTO `boss`.`user` (`ID`, `USER_NAME`, `USER_PWD`, `NAME`) VALUES ('3', 'test1', 'test1', 'test1');
INSERT INTO `boss`.`user` (`ID`, `USER_NAME`, `USER_PWD`, `NAME`) VALUES ('4', 'test2', 'test2', 'test2');